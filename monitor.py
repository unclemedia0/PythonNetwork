...
L = Label(GUI,text='ກຳລັງທຳອາຫານ...',font=(None,40),foreground='orange')
L.pack()

v_cooking = StringVar()
result1 = Label(GUI,textvariable=v_cooking,font=(None,40))
result1.pack()


L = Label(GUI,text='ໄດ້ຮັບເເລ້ວ...',font=(None,40),foreground='green')
L.pack()

v_finish = StringVar()
result1 = Label(GUI,textvariable=v_finish,font=(None,40))
result1.pack()
